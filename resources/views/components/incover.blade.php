...
@endif
<div class="form-group has-feedback has-feedback-left {{ $attributes->has('error') && $attributes->get('error') ? "has-error" : '' }}">
    {!! $slot !!}
    ...
    @endif
    @include('admin.blocks._input_error_block',['error' => $attributes->has('error') && $attributes->get('error') ? $attributes->get('error') : null])
</div>
